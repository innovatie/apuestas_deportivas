...
class Edit_form_template extends Edit_form
{
	...
	function addPassword(){
		...
		$data .= '</div></li><li class="fields pageFields_'.$this->pages.' '.$topclass.'"><div class="fieldset"><label>'.__($this->field['label2'],"piereg").'</label><div '.$fclass.'><input id="confirm_password_'.$this->id.'" type="password" class="input_fields '.$this->field['css'].' piereg_validate[equals['.$this->id.']]" placeholder="'.$this->field['placeholder2'].'" value="" name="confirm_password" autocomplete="off">';
	...
	function addLabel()
	{
		...
		return '<label for="'.$this->id.'">'. __($this->field['label'],"piereg").$field_required.'</label>';		
	}
