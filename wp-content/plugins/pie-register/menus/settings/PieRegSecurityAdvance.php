...
if( !isset($_GET['act']) || !isset($_GET['pie_id']) || !isset($_GET['option']) )
{
    ...
    <?php if( function_exists( 'wp_nonce_field' )) wp_nonce_field( 'piereg_wp_settings_security_advanced','piereg_settings_security_advanced'); ?>
        ...
        <div class="fields">
            ...
            <input <?php echo $_disable; ?> type="submit" class="submit_btn flt_none" value="<?php _e("Save Settings","piereg"); ?>" />
        </div>
    </form>
<hr class="seperator" />    
<?php 
	...
	?>
<h2 class="hydin_without_bg mar_none"><?php _e("Restrict Widgets",'piereg') ?></h2>
...
<?php } else { ?>
	<p><?php _e('You need to upgrade to PRO to use this Restrict Widgtets feature. Want to learn about this feature ?.','piereg');?> 
    <a href="https://pieregister.com/manual/pie-register-features/7329-2/" target="_blank"><?php _e('Click Here','piereg');?></a>
    </p>
<?php } ?>
