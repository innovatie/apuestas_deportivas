        	...
        	<?php if($action == "documentation" || $action == ""){ ?>
                ...
                <div class="pieHelpMenuButtonContaner">
                    <ul class="pieHelpMenuButton">
                        ...
                        <li><a href="http://pieregister.com/forums/forum/pie-register-3-0-support/" target="_blank_pieHelp_2"><?php _e("Pie-Register v3.0 and above Problems","piereg"); ?></a></li>
                        <li><a href="http://pieregister.com/forum/" target="_blank_pieHelp_3"><?php _e("Go To Forums","piereg"); ?></a></li>
                        <li><a href="https://pieregister.com/manual/introduction/" target="_blank_pieHelp_4"><?php _e("Pie Register Manual","piereg"); ?></a></li>
                        <li><a href="https://pieregister.com/manual/lets-get-started/" target="_blank_pieHelp_5"><?php _e("Getting Started","piereg"); ?></a></li>
                        <li><a href="https://pieregister.com/manual/community-vs-pro-version/" target="_blank_pieHelp_6"><?php _e("Community v/s PRO version","piereg"); ?></a>
                        </li>
                        <li><a href="https://pieregister.com/forums/forum/installation-problems/" target="_blank_pieHelp_7"><?php _e("Installation Problems","piereg"); ?></a></li>
                        <li><a href="https://pieregister.com/manual/pie-register-features/" target="_blank_pieHelp_8"><?php _e("Pie Register Features","piereg"); ?></a></li>
                        ...
                        <li><a href="https://wordpress.org/support/plugin/pie-register/reviews/?filter=5" target="_blank_pieHelp_9"><?php _e("Enjoying Pie Register ? Give us a rating.","piereg"); ?>!</a></li>
                    </ul>
                </div>
