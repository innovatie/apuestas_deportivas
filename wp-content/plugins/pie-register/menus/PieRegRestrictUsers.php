...
<div class="pieregister-admin">
  <div class="settings">
    <h2 class="top_heading">
      <?php _e("Block Users",'piereg');?> <?php echo $_available_in_pro; ?>
    </h2>
    <?php
              ...
              <form method="post" action="#piereg_block_by_username">
                ...
                <div class="fields">
                  ...
                  <label for="enable_blockedusername">
                    <?php _e("Do not allow users listed below to login or registration to my site.","piereg"); ?>
                  </label>
                </div>
                <div class="fields">
                  <h3>
...
use new line","piereg");?>. <span class="align_right"><strong>
                ...
                <div class="fields fields_submitbtn">
                  ...
                  <input <?php echo $_disable; ?> name="Submit" class="submit_btn" value="<?php _e('Save Changes','piereg');?>" type="submit" />
                </div>
              </form>
            </div>
          </div>
              ...
              <form method="post" action="#piereg_block_by_ip">
                ...
                <div class="fields">
                  ...
                  <label for="enable_blockedips">
                    <?php _e("Do not allow login or registration from IP Addresses/Subnets listed below.","piereg"); ?>
                  </label>
                </div>
                <div class="fields">
                  <h3>
                  ...
                  <div class="note_parent width_full flt_lft">
                    <div class="note"> <strong>
                      <?php _e("Note","piereg");?>
                      :</strong>
                      <?php _e("Enter each IP address on a new line","piereg");?>. <span class="align_right"><strong>
                      <?php _e("Example","piereg");?>
                      :</strong> <br />
                      192.168.1.1<br/>
              ...
              <form method="post" action="#piereg_block_by_email">
                ...
                <div class="fields">
                  ...
                  <label for="enable_blockedemail">
                    <?php _e("Do not allow login or registration using email address listed below .","piereg"); ?>
                  </label>
                </div>
                <div class="fields">
                  <h3>
