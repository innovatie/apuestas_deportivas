        ...
        <ul>
          ...
          <li>
            <div class="fields">
              ...
              <input style="float:left;" value="<?php echo (isset($this->pie_post_array['invitation_code_usage'])?$this->pie_post_array['invitation_code_usage']:''); ?>" type="text" name="invitation_code_usage" class="input_fields2" />
