...
<?php 	$_disable = $_available_in_pro 	= "";
		if(!$this->piereg_pro_is_activate)	{
			$_disable 			= "disabled";
			$_available_in_pro 	= '- <span style="color:red;">'. __("Available in Pro version","piereg") . '</span>';
		}
		?>
  ...
  <div class="settings" style="padding-bottom:0px;">
    ...
    <div class="right_section importexport">
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("All Settings",'piereg') ?> <?php echo $_available_in_pro; ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input <?php echo $_disable ?> type="submit" name="export_general_settings" value=" <?php _e("Export","piereg"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php echo $_disable ?>  type="submit" name="import_general_settings" value=" <?php _e("Import","piereg"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("E-mail Templates",'piereg') ?> <?php echo $_available_in_pro; ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php echo $_disable ?> type="submit" name="export_email_template" value=" <?php _e("Export","piereg"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php echo $_disable ?> type="submit" name="import_email_template" value=" <?php _e("Import","piereg"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("Invitation Codes",'piereg') ?> <?php echo $_available_in_pro; ?>
        </legend>
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php echo $_disable ?> type="submit" name="export_invitations_codes" value=" <?php _e("Export","piereg"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php echo $_disable ?> type="submit" name="import_invitations_codes" value=" <?php _e("Import","piereg"); ?> " 
      ...
      <fieldset class="piereg_fieldset_area">
        <legend>
        <?php _e("All Users Data With Custom Fields",'piereg') ?> <?php echo $_available_in_pro; ?>
        </legend>
        <?php
			if(isset( $this->pie_post_array['successfull_import_all_users_data'] ) && !empty( $this->pie_post_array['successfull_import_all_users_data'] ))
				echo '<p class="success">' . sprintf( __("(%d) user(s) successfully imported","piereg"), intval($this->pie_post_array['successfull_import_all_users_data']) ) . "</p>";
			if(isset( $this->pie_post_array['unsuccessfull_import_all_users_data'] ) && !empty( $this->pie_post_array['unsuccessfull_import_all_users_data'] ))
				echo '<p class="error">' . sprintf( __("(%d) user(s) are already exists","piereg"), intval($this->pie_post_array['unsuccessfull_import_all_users_data']) ) . "</p>";
			?>
        <div class="fields">
          <form method="post" action="">
            ...
            <input type="hidden" name="import_export_settings" value="1" />
            <input <?php echo $_disable ?> type="submit" name="piereg_export_user_custom_data" value=" <?php _e("Export","piereg"); ?> " class="button button-primary button-large"  />
          </form>
        </div>
        <div class="fields">
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="file_container">
              ...
              <input type="hidden" name="import_export_settings" value="1" />
              <input <?php echo $_disable ?> type="submit" name="piereg_import_user_custom_data" value="<?php _e("Import","piereg"); ?>" 
      ...
      <div class="import">
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <ul>
            ...
            <li>
              <div class="fields"> <span style="float:left"><?php echo sprintf( __( 'You may want to see', 'piereg').' <a target="_blank" download href="%s"> '.__('the example of the CSV file', 'piereg').'</a>.' , plugin_dir_url(__FILE__).'examples/example.csv'); ?></span>
                <div class="piereg_clear"></div>
              </div>
            </li>
            <li>
