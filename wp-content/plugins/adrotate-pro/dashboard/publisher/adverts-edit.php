...
if($ad_edit_id AND $edit_banner->type != 'empty' AND $edit_banner->type != 'generator') {
	...
	if($adstate == 'unpaid')
		echo '<div class="error"><p>'. __('This advert has not been paid for!', 'adrotate-pro').'</p></div>';
	...
	if($edit_banner->responsive == 'Y') 
		echo '<div class="error"><p>'. __('This advert uses the obsolete Responsive feature. Please use the more reliable Mobile feature! Saving the advert will disable the responsive option silently.', 'adrotate-pro').'</p></div>';
}
...
?>
	...
	<input type="hidden" name="adrotate_paid" value="<?php echo $edit_banner->paid;?>" />
...
<?php } ?>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
      	<tr>
	        ...
	        <td colspan="2">
	        	<label for="adrotate_title"><input tabindex="1" id="adrotate_title" name="adrotate_title" type="text" size="70" class="search-input" value="<?php echo stripslashes($edit_banner->title);?>" autocomplete="off" /> <em><?php _e('Visible to Advertisers!', 'adrotate-pro'); ?></em></label>
	        </td>
      	</tr>
      	<tr>
	        ...
	        <td colspan="2">
		        <label for="adrotate_active">
			        <select tabindex="7" name="adrotate_active">
						<option value="active" <?php if($edit_banner->type == "active") { echo 'selected'; } ?>><?php _e('Enabled, this advert will be visible', 'adrotate-pro'); ?></option>
						<option value="disabled" <?php if($edit_banner->type == "disabled" OR $edit_banner->type == "error") { echo 'selected'; } ?>><?php _e('Disabled, do not show this advert anywhere', 'adrotate-pro'); ?></option>
	...
	<table class="widefat" style="margin-top: .5em">
		<tbody>
      	...
      	<tr>
	        <th width="20%"><?php _e('In a post or page', 'adrotate-pro'); ?></th>
	...
	<h2><?php _e('Create a schedule', 'adrotate-pro'); ?></h2>
	...
	<table class="widefat" style="margin-top: .5em">
		<tr>
	        <th width="20%"><?php _e('Start date (dd-mm-yyyy)', 'adrotate-pro'); ?></th>
	        <td width="30%">
				<input tabindex="9" type="text" id="startdate_picker" name="adrotate_start_date" value="" class="datepicker" autocomplete="off"/>
	        </td>
	        <th width="20%"><?php _e('End date (dd-mm-yyyy)', 'adrotate-pro'); ?></th>
	        <td>
				<input tabindex="10" type="text" id="enddate_picker" name="adrotate_end_date" value="" class="datepicker" autocomplete="off" />
			</td>
      	</tr>	
		<tr>
	        ...
	        <td>
				...
				<input tabindex="11" name="adrotate_start_hour" class="search-input" type="text" size="2" maxlength="4" value="" autocomplete="off" /> :
				<input tabindex="12" name="adrotate_start_minute" class="search-input" type="text" size="2" maxlength="4" value="" autocomplete="off" />
				</label>
	        </td>
	        <th><?php _e('End time (hh:mm)', 'adrotate-pro'); ?></th>
	        <td>
	        	<label for="adrotate_eday">
				<input tabindex="13" name="adrotate_end_hour" class="search-input" type="text" size="2" maxlength="4" value="" autocomplete="off" /> :
				<input tabindex="14" name="adrotate_end_minute" class="search-input" type="text" size="2" maxlength="4" value="" autocomplete="off" />
				</label>
			</td>
      	</tr>	
		<?php if($adrotate_config['stats'] == 1) { ?>
      	<tr>
	        ...
	        <td><input tabindex="15" name="adrotate_maxclicks" type="text" size="5" class="search-input" autocomplete="off" value="" /> <em><?php _e('Leave empty to skip this.', 'adrotate-pro'); ?></em></td>
		    <th><?php _e('Maximum Impressions', 'adrotate-pro'); ?></th>
	        <td><input tabindex="16" name="adrotate_maxshown" type="text" size="5" class="search-input" autocomplete="off" value="" /> <em><?php _e('Leave empty to skip this.', 'adrotate-pro'); ?></em></td>
		</tr>
	    <tr>
	...
	<h2><?php _e('Choose Schedules', 'adrotate-pro'); ?></h2>
	...
	<table class="widefat" style="margin-top: .5em">
		...
		<tbody>
		<tr>
	        <th width="20%" valign="top"><?php _e('Show to everyone', 'adrotate-pro'); ?></th>
	        <td colspan="5">
       	...
       	<tr>
		    <th width="20%" valign="top"><?php _e('Weight', 'adrotate-pro'); ?></th>
	        <td width="16%">
		...
		<tr>
	        <th width="20%" valign="top"><?php _e('Device', 'adrotate-pro'); ?></th>
	        <td>
	        	<label for="adrotate_desktop"><center><input tabindex="25" type="checkbox" name="adrotate_desktop" <?php if($edit_banner->desktop == 'Y') { ?>checked="checked" <?php } ?> /><br /><?php _e('Computers', 'adrotate-pro'); ?></center></label>
	        </td>
	        <td>
	        ...
	        <td colspan="2" rowspan="2">
	        	<em><?php _e('Also enable mobile support in the group this advert goes in or these are ignored.', 'adrotate-pro'); ?><br /><?php _e('Operating system detection only detects iOS/Android/Other or neither.', 'adrotate-pro'); ?></em>
	        </td>
		</tr>
     	<tr>
	        <th width="20%" valign="top"><?php _e('Operating System', 'adrotate-pro'); ?></th>
	        <td>
	        ...
	        <td>
	        	<label for="adrotate_other"><center><input tabindex="30" type="checkbox" name="adrotate_other" <?php if($edit_banner->os_other == 'Y') { ?>checked="checked" <?php } ?> /><br /><?php _e('Other', 'adrotate-pro'); ?></center></label>
	        </td>
		</tr>
     	<tr>
	        <th width="20%" valign="top"><?php _e('Auto-delete', 'adrotate-pro'); ?></th>
	        <td colspan="5">
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox-ajdg">
						<div class="inside">
							...
							<textarea tabindex="32" name="adrotate_geo_cities" class="geo-cities" cols="40" rows="6"><?php echo (is_array($cities)) ? implode(', ', $cities) : ''; ?></textarea><br />
	...
	<table class="widefat" style="margin-top: .5em">	
		...
		<tbody>
      	<tr>
	        <th width="20%" valign="top"><?php _e('Advertiser', 'adrotate-pro'); ?></th>
	        <td colspan="3">
		...
		<?php if($adrotate_config['stats'] == 1) { ?>
     	<tr>
	        <th width="20%"><?php _e('Advert Budget', 'adrotate-pro'); ?></th>
	        <td colspan="3"><label for="adrotate_budget"><input tabindex="34" name="adrotate_budget" type="text" size="10" class="search-input" autocomplete="off" value="<?php echo number_format($edit_banner->budget, 2, '.', '');?>" /> <em><?php _e('When the budget reaches 0, the advert will expire.', 'adrotate-pro'); ?></em></label></td>
		</tr>
		<tr>
	        <th width="20%"><?php _e('Cost-per-Click', 'adrotate-pro'); ?></th>
	        <td width="30%"><label for="adrotate_crate"><input tabindex="35" name="adrotate_crate" type="text" size="10" class="search-input" autocomplete="off" value="<?php echo number_format($edit_banner->crate, 4, '.', '');?>" /> <em><?php _e('Leave empty to skip this.', 'adrotate-pro'); ?></em></label></td>
	        <th width="20%"><?php _e('Cost-per-Mille', 'adrotate-pro'); ?></th>
	        <td><label for="adrotate_irate"><input tabindex="36" name="adrotate_irate" type="text" size="10" class="search-input" autocomplete="off" value="<?php echo number_format($edit_banner->irate, 4, '.', '');?>" /> <em><?php _e('Leave empty to skip this.', 'adrotate-pro'); ?></em></label></td>
		</tr>
		<?php } ?>
		</tbody>
