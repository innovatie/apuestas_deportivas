		...
		<?php } ?>
	   	...
	   	<table class="widefat" style="margin-top: .5em">
		    ...
		    <tr>
				...
				<td width="35%">
					<label for="adrotate_groupname"><input tabindex="1" name="adrotate_groupname" type="text" class="ajdg-fullwidth ajdg-inputfield" size="50" value="<?php echo $edit_group->name; ?>" autocomplete="off" /></label>
				</td>
				<td>
