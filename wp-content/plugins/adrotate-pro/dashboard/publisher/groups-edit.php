	...
	<?php } ?>
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2">
		       	<label for="adrotate_modus"><select tabindex="2" name="adrotate_modus">
		        	<option value="0" <?php if($edit_group->modus == 0) { echo 'selected'; } ?>><?php _e('Default - Show one ad at a time', 'adrotate-pro'); ?></option>
		        	<option value="1" <?php if($edit_group->modus == 1) { echo 'selected'; } ?>><?php _e('Dynamic - Show a different ad every few seconds', 'adrotate-pro'); ?></option>
		        	<option value="2" <?php if($edit_group->modus == 2) { echo 'selected'; } ?>><?php _e('Block - Show a block of adverts', 'adrotate-pro'); ?></option>
		        </select><br />
				<em><?php _e('Dynamic mode requires jQuery. You can enable this in AdRotate Settings.', 'adrotate-pro'); ?></em></label>
			</td>
		</tr>
	    <tr>
			<th valign="top"><?php _e('Advert size', 'adrotate-pro'); ?></strong></th>
			<td width="35%">
				<label for="adrotate_adwidth"><input tabindex="3" name="adrotate_adwidth" type="text" class="search-input" size="3" value="<?php echo $edit_group->adwidth; ?>" autocomplete="off" /> <?php _e('px wide', 'adrotate-pro'); ?>,</label> <label for="adrotate_adheight"><input tabindex="4" name="adrotate_adheight" type="text" class="search-input" size="3" value="<?php echo $edit_group->adheight; ?>" autocomplete="off" /> <?php _e('px high.', 'adrotate-pro'); ?></label>
			</td>
			<td>
	...
	<p><em><?php _e('Only required if your group is in Dynamic or Block mode.', 'adrotate-pro'); ?></em></p>
   	<table class="widefat" style="margin-top: .5em">
		...
		<tr>
			...
			<td>
				<label for="adrotate_repeat_impressions"><input type="checkbox" name="adrotate_repeat_impressions" <?php if($edit_group->repeat_impressions == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Count impressions for every cycle of adverts?', 'adrotate-pro'); ?></label>
			</td>
			<td>
	...
	<h2><?php _e('Advanced', 'adrotate-pro'); ?></h2>
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td width="35%">
				<label for="adrotate_geo"><input tabindex="14" type="checkbox" name="adrotate_geo" value="1" <?php if($edit_group->geo == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable Geo Targeting for this group.', 'adrotate-pro'); ?></label>
			</td>
			<td>
	    ...
	    <tr>
			...
			<td width="35%">
				<label for="adrotate_mobile"><input tabindex="15" type="checkbox" name="adrotate_mobile" value="1" <?php if($edit_group->mobile == '1') { ?>checked="checked"<?php } ?> /> <?php _e('Enable mobile support for this group.', 'adrotate-pro'); ?></label>
			</td>
			<td>
	...
	<p class="submit">
   	...
   	<table class="widefat" style="margin-top: .5em">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="23" name="adrotate_wrapper_before" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_before); ?></textarea></td>
			<td width="35%">
	    ...
	    <tr>
			...
			<td colspan="2"><textarea tabindex="24" name="adrotate_wrapper_after" cols="65" rows="3"><?php echo stripslashes($edit_group->wrapper_after); ?></textarea></td>
			<td>
