...
------------------------------------------------------------------------------------ */
?>
<h2><?php _e('Advert Bin', 'adrotate-pro'); ?></h2>
<p><em><?php _e('The bin is a temporary place for deleted adverts. If an advert is deleted by accident you can restore it from here. If nothing is done the advert is deleted after 3 days. Once the advert has been deleted it can no longer be recovered.', 'adrotate-pro'); ?></em></p>

<form name="banners" id="post" method="post" action="admin.php?page=adrotate-ads&view=bin">
	<?php wp_nonce_field('adrotate_bulk_ads_bin','adrotate_nonce'); ?>
