	...
	<form method="post" action="admin.php?page=adrotate-schedules">
		...
		<table class="widefat" style="margin-top: .5em">
			<tbody>
	      	<tr>
		        ...
		        <td>
		        	<label for="adrotate_schedulename"><input tabindex="1" name="adrotate_schedulename" type="text" class="ajdg-fullwidth ajdg-inputfield" size="50" value="<?php echo stripslashes(html_entity_decode($edit_schedule->name)); ?>" autocomplete="off" /></label>
				</td>
		        <td colspan="2">
			...
			<tr>
		        ...
		        <td width="35%">
					<input tabindex="2" type="text" id="startdate_picker" name="adrotate_start_date" value="<?php echo $start_date; ?>" class="datepicker ajdg-inputfield" />
		        </td>
		        <th width="15%"><?php _e('End date', 'adrotate-pro'); ?> (dd-mm-yyyy)</th>
		        <td>
					<input tabindex="3" type="text" id="enddate_picker" name="adrotate_end_date" value="<?php echo $end_date; ?>" class="datepicker ajdg-inputfield" />
				</td>
	      	</tr>	
			<tr>
		...
		<table class="widefat" style="margin-top: .5em">
		    ...
		    <tr>
				...
				<td colspan="3"><label for="adrotate_spread"><input tabindex="21" type="checkbox" name="adrotate_spread" value="1" <?php if($edit_schedule->spread == 'Y') { ?>checked<?php } ?> /> <?php _e('Evenly spread impressions for each advert over the duration of this schedule.', 'adrotate-pro'); ?></label><br /><em><?php _e('Requires Maximum Impressions to be higher than 100.', 'adrotate-pro'); ?></td>
			</tr>
			<?php } ?>
	     	<tr>
		        <th valign="top"><?php _e('Auto-delete', 'adrotate-pro'); ?></th>
		        <td colspan="3">
		        	<label for="adrotate_autodelete"><input tabindex="22" type="checkbox" name="adrotate_autodelete" <?php if($edit_schedule->autodelete == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Automatically delete the schedule 1 day after it expires?', 'adrotate-pro'); ?></label><br /><em><?php _e('This is useful for short running campaigns that do not require attention after they finish.', 'adrotate-pro'); ?></em>
		        </td>
			</tr>
			</tbody>	
