...
<table class="form-table">			
	...
	<tr>
		...
		<td><label for="adrotate_borlabscache"><input type="checkbox" name="adrotate_borlabscache" <?php if($adrotate_config['borlabscache'] == 'Y') { ?>checked="checked" <?php } ?> /> <?php _e('Check this box if you use Borlabs Caching on your site.', 'adrotate-pro'); ?></label></td>
	</tr>
	<tr>
		<th valign="top">&nbsp;</th>
