<?php
/***************************************
*	Palpites Loop Function
***************************************/

vc_map( array(
	"name" => __("Palpites Loop"),
	"base" => "palpites-loop",
	"category" => __('Content'),
	"params" => array(
		array(
			...
			"param_name" => "quantity",
			"value" => __(""),
			"description" => __("Number of Palpites to show")
		)
   	)
));

add_shortcode('palpites-loop', 'goapostas_palpites_loop');
function goapostas_palpites_loop($atts,$content){
